...
vim.keymap.set('n', '<leader>ww', '<C-w><C-w>', { desc = 'Move focus to the next window' })
vim.keymap.set('n', '<leader>wd', '<C-w>c', { desc = 'Close the current window' })
...
vim.keymap.set('n', '<TAB>', ':bn<CR>', { desc = 'Switch to previous buffer' })
vim.keymap.set('n', '<S-TAB>', ':bp<CR>', { desc = 'Switch to next buffer' })
